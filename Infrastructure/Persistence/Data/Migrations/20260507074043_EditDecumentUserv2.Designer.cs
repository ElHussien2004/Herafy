...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20260507074043_EditDecumentUserv2")]
    partial class EditDecumentUserv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.OrderEntity.Complaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.UsersEntity.UserDocument", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.UsersEntity.UserDocument", b =>
                {
                    b.HasOne("Domain.Entities.UsersEntity.ApplicationUser", "User")
                        .WithOne("Document")
                        .HasForeignKey("Domain.Entities.UsersEntity.UserDocument", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
